...
<body>
    <script language = "javascript" type = "text/javascript">
        function ajaxFunction(user, pwd){
            ...
            if (username == "" || password == ""){
                ...
                ajaxVar.open("GET", "signinserver.php" + queryString, true);
                ajaxVar.send(null); 
            }
        }
    </script>
    <div id = "container">
        ...
        <div id = "header">
            <a class = "active" href = "homepage.php"><h1>Mosaic | Sign In</h1></a>
        ...
        <div id = "credentials">
            ...
            <h3> Mosaic Sign In</h3>
                <?php
                    ...
                    echo "<input type = 'button' onclick = \"ajaxFunction('$user','$pwd')\" value = 'Sign In'/> <br><br> ";
                    echo "</td> </tr>	</table>";  
                ?>
            </form>  
            <div id = 'ajaxDiv'> </div>
