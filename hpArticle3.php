<?php
    $url =     $url = "https://newsapi.org/v2/top-headlines?country=us&category=general&apiKey=18413fe6fbd94296b3e8eaf042057723";;
...
<body>
    <div id = "container">
        ...
        <div id = "header">
	    <a class = "active" href = "homepage.php"><h1>Mosaic | General</h1></a>
	...
	<div class = "opinion">
        <h2><a href = "homepage.php">Other Articles</a></h2>
        <h3><a href = "hpArticle1.php">$titles[0]</a></h3>
        <h3><a href = "hpArticle2.php">$titles[1]</a></h3>
        <h3><a href = "hpHeadline1.php">$titles[3]</a></h3>
