<?php
    $url = "https://newsapi.org/v2/top-headlines?country=us&apiKey=18413fe6fbd94296b3e8eaf042057723";
...
<body>
    <div id = "container">
        ...
        <div id = "header">
	    <a class = "active" href = "homepage.php"><h1>Mosaic | United States</h1></a>
	...
	<div class = "story">
	<h3><a href = "USArticle1.php">$titles[0]</a></h3>
	<p>$descriptions[0]</p>
	<h3><a href = "USArticle2.php">$titles[1]</a></h3>
	<p>$descriptions[1]</p>
	<h3><a href = "USArticle3.php">$titles[2]</a></h3>
	<p>$descriptions[2]</p>
	</div>

	<div class = "opinion">
	<h3><a href = "USOped1.php">$titles[3]</a></h3>
	<p>$descriptions[3]</p>
	<h3><a href = "USOped2.php">$titles[4]</a></h3>
	<p>$descriptions[4]</p>
	<h3><a href = "USOped3.php">$titles[5]</a></h3>
	<p>$descriptions[5]</p>
	</div>

	<div class = "headline">
	<div style = "height:220px;">
		<h3><a href = "USArticle4.php">$titles[6]</a></h3>
		<div class = "floatleft">
	...
	<div style = "height:220px;">
		<h3><a href = "USArticle5.php">$titles[7]</a></h3>
	...
	<div style = "height:220px;">
        	<h3><a href = "USArticle6.php">$titles[8]</a></h3>
		<div class = "floatleft">
